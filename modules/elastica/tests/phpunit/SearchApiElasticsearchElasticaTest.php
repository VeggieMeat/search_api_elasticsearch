...
class SearchApiElasticsearchElastica extends SearchApiElasticsearchBaseTest {
  ...
  public function testAddIndex() {
    ...
    $this->assertTrue($this->_index->getIndexName(), $this->_client->getElasticaIndex($this->_index)->getName());
  }
